...
const de: Dict = {
  ...
  "rules.delete": "Löschen (endgültig)",
  "mail.blockSender": "Absender blockieren",
  "mail.blockConfirm": "Alle E-Mails von {sender} ab sofort automatisch und endgültig löschen?\n\nVorhandene Mails dieses Absenders (Posteingang + Spam) werden sofort unwiderruflich gelöscht. Künftige Mails werden automatisch entfernt.",
...
const en: Dict = {
  ...
  "rules.delete": "Delete (permanent)",
  "mail.blockSender": "Block sender",
  "mail.blockConfirm": "Permanently delete all e-mails from {sender} from now on?\n\nExisting messages from this sender (inbox + spam) are deleted immediately and irreversibly. Future messages are removed automatically.",
