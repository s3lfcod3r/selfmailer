...
const de: Dict = {
  ...
  // Sync & Export
  "sync.never": "noch nie",
  "mig.heading": "Postfach-Migration (z. B. von Synology)",
  "mig.hint": "Kopiert Mails aus einem Quellkonto (Synology als IMAP-Konto hinzufügen!) in deine übrigen Konten — jede Mail landet beim Konto, dessen Adresse als Empfänger eingetragen ist. Mach zuerst einen Testlauf.",
  "mig.pickSource": "Quellkonto wählen …",
  "mig.sourceFolder": "Quellordner (Standard INBOX)",
  "mig.targetFolder": "Zielordner (Standard INBOX)",
  "mig.dryRun": "Testlauf",
  "mig.run": "Migrieren",
  "mig.running": "läuft …",
  "mig.confirm": "Mails jetzt wirklich in die Zielkonten kopieren?",
  "mig.previewResult": "Vorschau (es wurde nichts kopiert)",
  "mig.doneResult": "Migration abgeschlossen",
  "mig.scanned": "{n} Mails geprüft",
  "mig.unmatched": "{n} ohne passendes Konto (übersprungen)",
  "mig.moved": "{n} kopiert",
  "mig.needSource": "Bitte ein Quellkonto wählen",
  "mig.limitHint": "max. {n} neueste Mails pro Lauf",
...
const en: Dict = {
  ...
  // Sync & Export
  "sync.never": "never",
  "mig.heading": "Mailbox migration (e.g. from Synology)",
  "mig.hint": "Copies mails from a source account (add Synology as an IMAP account!) into your other accounts — each mail lands in the account whose address is the recipient. Do a dry run first.",
  "mig.pickSource": "Choose source account …",
  "mig.sourceFolder": "Source folder (default INBOX)",
  "mig.targetFolder": "Target folder (default INBOX)",
  "mig.dryRun": "Dry run",
  "mig.run": "Migrate",
  "mig.running": "running …",
  "mig.confirm": "Really copy mails into the target accounts now?",
  "mig.previewResult": "Preview (nothing was copied)",
  "mig.doneResult": "Migration finished",
  "mig.scanned": "{n} mails scanned",
  "mig.unmatched": "{n} without matching account (skipped)",
  "mig.moved": "{n} copied",
  "mig.needSource": "Please choose a source account",
  "mig.limitHint": "up to {n} newest mails per run",
